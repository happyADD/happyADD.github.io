...
# 所获奖项
RoboMaster2025 东部赛区 第四名 一等奖
RoboMaster2025 工程机器人兵种奖 一等奖 
## 项目概述
...
## 经典问题与解决方案
自制的机械臂不存在显式解，调用MoveIt2中逆运动学求解器时出现求解缓慢、奇异位形、无解姿态较多，导致失败率较高，运动规划到执行的过程较长以及碰撞精度等问题。

解决方案：1.延长求解限制时间，2.将目标位置向工作空间边缘平移+随机位置移动，同时求解出机械臂运动轨迹和底盘补偿位姿，3.运动末端物体姿态限制放宽，以求弥补传感器数据与真值的差距，实现依靠规划＋重力保障准确率。
...
- 延伸成果：完成“预测时间多约束的柔性机械臂轨迹跟踪控制”论文
